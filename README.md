...
- Timestamp: `2022-05-28 14:36`
- Build ID: `d915bf9f-6f75-4ddc-a8d9-dbcb72ed0f12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d915bf9f-6f75-4ddc-a8d9-dbcb72ed0f12.git
$ cd d915bf9f-6f75-4ddc-a8d9-dbcb72ed0f12
```
